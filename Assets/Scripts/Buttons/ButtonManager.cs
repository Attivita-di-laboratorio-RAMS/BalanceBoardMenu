    ...
    private void Awake(){
      playButton.onClick.AddListener(() => {
        if(!_isPlaying){
          ...
          //MotionPlatform.Instance.SendRequest(PlatformState.Running);
        }
        else{
      ...
      homeButton.onClick.AddListener(() => {
        /*if (MotionPlatform.Instance.PlatformData.state == (int)PlatformState.Park)
        {
            MotionPlatform.Instance.SendRequest(PlatformState.Ready);
        }
        else if (MotionPlatform.Instance.PlatformData.state == (int)PlatformState.Ready)
        {
            MotionPlatform.Instance.SendRequest(PlatformState.Park);
        }*/
