        ...
        private void Awake()
        {
            ...
            searchUsernameButton.onClick.AddListener(() =>
            {
                ...
                if (found)
                    ...
                    JsonUtility
                        .FromJson<AccountSettingsSerializable>(
                            File.ReadAllText(FolderPath + usernameInputField.text + Extension))
                        .FillAccountSettings();
                else
                    //GameSettings with default settings
                    JsonUtility
                        .FromJson<AccountSettingsSerializable>(
                            File.ReadAllText(FolderPath + DefaultFilename + Extension))
                        .FillAccountSettings(); //end-if
            });
        }
        /***************************************/
    }
