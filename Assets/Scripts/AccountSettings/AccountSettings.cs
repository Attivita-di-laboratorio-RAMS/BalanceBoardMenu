...
namespace AccountSettings
{
    ...
    public class AccountSettings : MonoBehaviour
    {
        ...
        public void DisableSettings()
        {
            ...
            foreach (var input in activeAnglesInputFieldsList)
            {
            ...
            foreach (var input in defaultMovementsAmpInputFieldsList)
            {
                input.interactable = false;
            } //end-foreach

            foreach (var input in defaultMovementsFreqInputFieldsList)
            {
                input.interactable = false;
            } //end-foreach
        }
